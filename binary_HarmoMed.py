...
def processing_img(refpath, targetpath):
    ...
    cv2.imwrite("static/results/true_corrected_img_rgb1.jpg", cv2.cvtColor(true_corrected_img_rgb, cv2.COLOR_RGB2BGR))
    plt.tight_layout()
    plt.savefig("static/results/result_plot.jpg", dpi=300)